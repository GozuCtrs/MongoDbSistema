...
<p>user:Marco    pass:1234</p>
    <div class="caja_principal">
        ...
        <form  action="/controllers/controladorLogin.php" method="POST" class="panel_derecho" autocomplete="off">
            <h1 class="titulo_login">login</h1>
            <?php if (!empty($mensaje)) { ?>
                <div id="output" class="mensaje_error">
            ...
            <input type="button" id="login-submit" class="btn_enviar caja_input_login texto_input_login" value="enviar">
        </form>
